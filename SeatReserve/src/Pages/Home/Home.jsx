...
function Home() {
  ...
  return (
    ...
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/src/assets/IMG_0143q.jpg")] bg-cover bg-center h-160 w-vw-100 '>
      <h1 className='text-5xl md:text-[70px] md:leading-18 font-semibold max-w-110 text-white'>Welcome to SeatReverve</h1>
    ...
    <div className='flex flex-col w-full '>
      <div className='flex flex-row  rounded-lg md:px-20 items-center justify-between p-3 border-2 border-black my-2 w-vw-100'>
        ...
        <button onClick={() => navigate("/trainlist/1")} className=' cursor-pointer text-white bg-primary md:text-2xl font-bold rounded-lg md:w-[200px] h-auto p-4 '>Book a Train</button>
      </div>
      <div className='flex flex-row  rounded-lg md:px-20 items-center justify-between p-3 border-2 border-black my-5 w-vw-100'>
        ...
        <button onClick={() => navigate("/trainlist/2")} className=' cursor-pointer text-white bg-primary md:text-2xl font-bold rounded-lg md:w-[200px] h-auto p-4 '>Book a Train</button>
      </div>
      <div className='flex md:flex-row flex:col  rounded-lg md:px-20 items-center justify-between p-3 border-2 border-black my-5 w-vw-100'>
        ...
        <button onClick={() => navigate("/trainlist/3")} className=' cursor-pointer text-white bg-primary md:text-2xl  font-bold rounded-lg md:w-[200px] h-auto p-4  '>Book a Train</button>
      </div>
      <div className='flex flex-row  rounded-lg md:px-20 items-center justify-between p-3 border-2 border-black my-5 w-vw-100'>
        <h5 className='md:text-2xl '>Eastern Line</h5>
        <p className='md:text-xl '>Colombo Fort to Batticaloa, Trincomalee</p>
        <button onClick={() => navigate("/trainlist/4")} className=' cursor-pointer text-white bg-primary md:text-2xl font-bold rounded-lg md:w-[200px] h-auto p-4 '>Book a Train</button>
      </div>
